...
#        1% sparse, Zipfian (p = 0.5 )
echo ""
echo "+================================================="
echo "||                                              ||"
echo "||                  Array_22.sh                 ||"
echo "|| SPARSE (1%) Array, Zipf (0.5) Distribution   ||"
echo "||                                              ||"
echo "+================================================="
echo ""
date
...
gen_matrix -r $1 $1 $2 $2 0.01 0.5 DDF > /tmp/Load.pipe &
#
/usr/bin/time -f "Array_22 Load %e" iquery -naq "load(Test_Array, '/tmp/Load.pipe')"
#
#  DML 1: How many cells?
#
/usr/bin/time -f "Array_22 Cell_Count %e" iquery -taq "
join ( 
        build ( < s : string > [ I=0:0,1,0 ], 'Array_22'),
        count ( Test_Array )
)"
#
#  Size
