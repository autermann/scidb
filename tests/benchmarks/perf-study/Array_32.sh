...
#        0.01% sparse, Zipfian p = 0.5 
#
echo ""
echo "+=================================================="
echo "||                                               ||"
echo "||                  Array_32.sh                  ||"
echo "|| SPARSE(0.011%) Array, Zipf (0.5) Distribution ||"
echo "||                                               ||"
echo "+=================================================="
echo ""
date
...
gen_matrix -r $1 $1 $2 $2 0.0001 0.5 DDF > /tmp/Load.pipe &
#
/usr/bin/time -f "Array_32 Load %e" iquery -naq "load(Test_Array, '/tmp/Load.pipe')"
#
# DML 1: How many cells?
#
/usr/bin/time -f "Array_32 Cell_Count %e" iquery -taq "
join ( 
        build ( < s : string > [ I=0:0,1,0 ], 'Array_32'),
        count ( Test_Array )
)"
#
#  Size
