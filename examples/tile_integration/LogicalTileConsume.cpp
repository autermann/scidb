...
/**
 * @brief The operator: tile_consume().
 *
 * @par Synopsis:
 *   tile_consume( array [, numAttrsToScanAtOnce] )
 *
 * @par Summary:
 ...
 *
 */
class LogicalTileConsume: public LogicalOperator
{
private:
    int _numVaryParam;

public:
    LogicalTileConsume(const string& logicalName, const std::string& alias):
...
REGISTER_LOGICAL_OPERATOR_FACTORY(LogicalTileConsume, "tile_consume");
} //namespace
