...
class PhysicalTileConsume: public PhysicalOperator
{
public:
    PhysicalTileConsume(const string& logicalName, const string& physicalName, const Parameters& parameters, const ArrayDesc& schema):
...
REGISTER_PHYSICAL_OPERATOR_FACTORY(PhysicalTileConsume, "tile_consume", "PhysicalTileConsume");
}  // namespace scidb
