...
ERRMSG(SCIDB_SE_NETWORK,                            "Network error");
ERRMSG(SCIDB_SE_SYNTAX,                             "Query syntax error");
ERRMSG(SCIDB_SE_OPTIMIZER,                          "Query optimizer error");
ERRMSG(SCIDB_SE_THREAD,                             "Thread sync primitive error");
ERRMSG(SCIDB_SE_PARSER,                             "Error during query parsing");
ERRMSG(SCIDB_SE_INFER_SCHEMA,                       "Error during schema inferring");
ERRMSG(SCIDB_SE_DBLOADER,                           "Error in loader");
ERRMSG(SCIDB_SE_INJECTED_ERROR,                     "Injected error");
ERRMSG(SCIDB_SE_IMPORT_ERROR,                       "Import error");
