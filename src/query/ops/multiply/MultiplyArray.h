...
#ifndef MULTIPLY_ARRAY_H
#define MULTIPLY_ARRAY_H
...
class MultiplyArrayIterator : public ConstArrayIterator
{
  public:
        ...
        MultiplyArrayIterator(MultiplyArray const& array, AttributeID id);

  protected:
    bool isSelfChunk() const;

    MultiplyArray const& array;
    AttributeID attr;
    Coordinates currPos;
    bool hasCurrent;
    MemChunk chunk;
...
class MultiplySparseArrayIterator : public MultiplyArrayIterator
{
  public:
        virtual ConstChunk const& getChunk();
        MultiplySparseArrayIterator(MultiplyArray const& array, AttributeID id);
...
class MultiplyArray : public Array
{
    friend class MultiplyArrayIterator;
    friend class MultiplySparseArrayIterator;
    ...
    class MultiplyJob : public Job
    {
      ...
      public:
        MultiplyJob(MultiplyArray const& array,
                    void const* leftData,
                    void const* rightData,
                    void* resultData,
