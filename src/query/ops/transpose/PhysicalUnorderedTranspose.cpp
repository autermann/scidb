...
class PhysicalUnorderedTranspose: public PhysicalOperator
{
public:
	PhysicalUnorderedTranspose(const string& logicalName, const string& physicalName, const Parameters& parameters, const ArrayDesc& schema):
	...
	boost::shared_ptr<Array> execute(vector< boost::shared_ptr<Array> >& inputArrays, boost::shared_ptr<Query> query)
    {
		...
		return boost::shared_ptr<Array>(new UnorderedTransposeArray(_schema, inputArrays[0]));
    }
};
    
DECLARE_PHYSICAL_OPERATOR_FACTORY(PhysicalUnorderedTranspose, "transpose", "physicalUnorderedTranspose")
