...
class LogicalFlip: public  LogicalOperator
{
public:
	LogicalFlip(const string& logicalName, const std::string& alias):
...
DECLARE_LOGICAL_OPERATOR_FACTORY(LogicalFlip, "redimension")
