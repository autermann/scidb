...
public class SciDBJDBCResultSet implements ResultSet
{
    private Array array;
    ...
    public SciDBJDBCResultSet(Array array) throws SQLException
    {
        this.array = array;
        metadata = new SciDBJDBCResultSetMetaData(this.array.getSchema());
    ...
    {
        if (iface == ISciDBJDBCResultSetWrapper.class)
        {
            return (T) new SciDBJDBCResultSetWrapper(this);
        }
        return null;
    }
    ...
    {
        return iface == ISciDBJDBCResultSetWrapper.class;
    }
        ...
        try
        {
            if (isAttribute(columnIndex))
            {
                ...
                else
                {
                    ...
                    {
                        throw new SciDBJDBCTypeException(attType, "String");
                    }
                }
            }
            else
    ...
    public boolean getBoolean(int columnIndex) throws SQLException
    {
        ...
        {
            throw new SciDBJDBCTypeException(metadata.getColumnTypeName(columnIndex), "boolean");
        }
    ...
    public byte getByte(int columnIndex) throws SQLException
    {
        ...
        {
            throw new SciDBJDBCTypeException(metadata.getColumnTypeName(columnIndex), "byte");
        }
        ...
        try
        {
            ...
            {
                String attType = metadata.getColumnTypeName(columnIndex);
                throw new SciDBJDBCTypeException(attType, "byte");
            }
        } catch (SciDBException e)
        {
            throw new SQLException(e);
        ...
        try
        {
            if (isAttribute(columnIndex))
            {
                ...
                } else
                {
                    ...
                    {
                        throw new SciDBJDBCTypeException(attType, "short");
                    }
                }
            }
            else
        ...
        try
        {
            if (isAttribute(columnIndex))
            {
                ...
                else
                {
                    ...
                    {
                        throw new SciDBJDBCTypeException(attType, "int");
                    }
                }
            }
            else
        ...
        try
        {
            if (isAttribute(columnIndex))
            {
                ...
                else
                {
                    ...
                    {
                        throw new SciDBJDBCTypeException(attType, "long");
                    }
                }
            }
            else
        ...
        try
        {
            if (isAttribute(columnIndex))
            {
                ...
                else
                {
                    ...
                    {
                        throw new SciDBJDBCTypeException(attType, "float");
                    }
                }
            }
            else
        ...
        try
        {
            if (isAttribute(columnIndex))
            {
                ...
                else
                {
                    ...
                    {
                        throw new SciDBJDBCTypeException(attType, "double");
                    }
                }
            }
            else
        ...
        try
        {
            if (isAttribute(columnIndex))
            {
                ...
                else
                {
                    ...
                    {
                        throw new SciDBJDBCTypeException(attType, "BigDecimal");
                    }
                }
            }
            else
