...
public class SciDBJDBCConnection implements java.sql.Connection
{
    private org.scidb.client.Connection scidbConnection;
    
    public SciDBJDBCConnection(String host, int port) throws SQLException
    {
    ...
    {
        return new SciDBJDBCStatement(this);
    }
